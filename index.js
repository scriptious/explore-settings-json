...
var script = `<script>window.jQuery("body>div").jJsonViewer(${System.IO.File.ReadAllText(abspath)})</script>`;

StrokesPlus.Configuration.Settings.ConvertToJSON();
StrokesPlus.UI.HTMLWindow(title, css + html + jsonViewer + script, '', '', '', true);